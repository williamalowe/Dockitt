      ...
      <div className={styles.wrapper}>
        <div className={styles.left}>
          ...
          <div className={styles.radio}>
            <input type="radio" name="status" ref={backlogCheck} onChange={checkHandler} value='backlog'/>
            <label>Backlog</label>
          </div>
          <div className={styles.radio}>
            <input type="radio" name="status" ref={inProgressCheck} onChange={checkHandler} value='in progress'/>
            <label>In Progress</label>
          </div>
          <div className={styles.radio}>
            <input type="radio" name="status" ref={underReviewCheck} onChange={checkHandler} value='under review'/>
            <label>Under Review</label>
          </div>
          <div className={styles.radio}>
            <input type="radio" name="status" ref={completedCheck} onChange={checkHandler} value='completed'/>
        ...
        <div className={styles.right}>
          ...
          <div className={styles.radio}>
            <input type="radio" name="priority" ref={lowCheck} onChange={checkHandler} value='low'/>
            <label>Low</label>
          </div>
          <div className={styles.radio}>
            <input type="radio" name="priority" ref={mediumCheck} onChange={checkHandler} value='medium'/>
            <label>Medium</label>
          </div>
          <div className={styles.radio}>
            <input type="radio" name="priority" ref={highCheck} onChange={checkHandler} value='high'/>
            <label>High</label>
          </div>
          <div className={styles.radio}>
            <input type="radio" name="priority" ref={urgentCheck} onChange={checkHandler} value='urgent'/>
            <label>Urgent</label>
          </div>
        </div>
      </div>
      <div className={styles.error} ref={errElement}>Task description is required.</div>
      <div className={styles.buttons}>
        <button className={styles.submit} onClick={handleSubmit}>Add Task</button>
        <button className={styles.submit} onClick={handleClose}>Close</button>
      </div>
    </div>
  )
}
